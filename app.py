...
if st.sidebar.button("Predict Disposition"):
    try:
        ...
        # ✅ FINAL ROBUST FIX: Use the scaler's expected number of features to build the input array.
        # This avoids all errors with column names and order.
        ...
        # Scale the correctly shaped array and make the prediction.
